...
/* Multiplex LED hardware support for RCL-57 retrofit
 * January 2024, Tom LeMense
 *
 *       --A--
 *      |     |
 *      F     B
...
static char SEGMENT_MAP[27][8] = {
  ...
  /*8*/ {1,1,1,1,1,1,1,0}, //A-B-C-D-E-F-G
	...
	/*-*/ {0,0,0,0,0,0,1,0}, //G
	/*P*/ {1,1,0,0,1,1,1,0}, //A-B-E-F-G
	/*r*/ {0,0,0,0,1,0,1,0}, //E-G
	/*o*/ {0,0,1,1,1,0,1,0}, //B-C-D-F
	/*G*/ {1,0,1,1,1,1,0,0}, //A-C-D-E-F
	/*U*/ {0,1,1,1,1,1,0,0}, //B-C-D-E-F-G
	/*C*/ {1,0,0,1,1,1,0,0}, //A-D-E-F
	/*a*/ {1,1,1,1,1,0,1,0}, //A-B-C-D-E-G
	/*i*/ {0,0,1,0,0,0,0,0}, //C
	/*n*/ {0,0,1,0,1,0,1,0}  //C-E-G
};
...
{
	if (c > 26) 	// if not a define character, consider it blank
	    c = 17;
...
/** parse dA (digits) and dB (mask) contents to determine which CAT4016 outputs should be active for segment s */ 
